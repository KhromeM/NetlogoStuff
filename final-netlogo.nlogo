...
set plabel-color black ]
ask patch -5 53 [ set plabel "Tyler the turtle was wondering the forest"
set plabel-color black ]
...
wait 2
ask patch -6 -11 [set plabel " Im goign to write a book about this!"]
ask patch -8 52 [set plabel "The turtle won the race!" set plabel-color black]
 ...
 wait 2
 ask patch 83 14 [set plabel "Fake news is not a joke guys  " set plabel-color black]
 wait 2
 ask patch 83 14 [set plabel "I was recently fired because of this book"]
wait 2
 ask patch 83 14 [set plabel "Please support me on gofundme.com"]
 wait 2
...
205
working
 crt 1\n [set nwho 6 set shape \"hare-head\"set heading 0\n  set size 18 setxy (-34.25 + 80) (-20.75 + 20)]\n crt 1\n [set nwho 7 set shape \"hare-body\" set size 18\n set heading 0 setxy ( -33.5 + 80) (-31 + 20)]\n crt 1\n [set nwho 8 set shape \"hf\" set size 18\n setxy -27.5 -45 set heading 30 setxy (-34.5 + 80) (-35.5 + 20)]\n crt 1\n [set nwho 9 set shape \"hf\" set size 18\n set heading -30 setxy -23 -45 setxy (-31.5 + 80) (-36 + 20)]\n wait 2\n ask patch 70 14 [set plabel \"Fake news is not a joke guys\" set plabel-color black]\n wait 2\n ask patch 70 14 [set plabel \"I was recently fired because of the book\"]\nwait 2\n ask patch 70 14 [set plabel \"Please support me on gofundme.com\"]\n wait 2\n 
NIL
1
T
OBSERVER
...
509
backwards
\n\nrepeat 27 [\n ask turtles with [ nwho = 6 ] [set xcor xcor - 1 wait .03]\n ask turtles with [ nwho = 7 ] [set xcor xcor - 1 wait .03]\n    ask turtles with [ nwho = 8 ] [set xcor xcor - 1 wait .01 set heading heading * -1 wait .02]\n    ask turtles with [ nwho = 9 ] [set xcor xcor - 1 wait .01 set heading heading * -1 wait .02]]\n    \n    ask turtles with [ nwho = 6 ] [set xcor xcor - 13 wait .03]\n ask turtles with [ nwho = 7 ] [set xcor xcor - 13 wait .03]\n    ask turtles with [ nwho = 8 ] [set xcor xcor - 13 wait .01 set heading heading * -1 wait .02]\n    ask turtles with [ nwho = 9 ] [set xcor xcor - 13 wait .01 set heading heading * -1 wait .02]\n\nrepeat 65 [\n ask turtles with [ nwho = 6 ] [set xcor xcor - 1 wait .03]\n ask turtles with [ nwho = 7 ] [set xcor xcor - 1 wait .03]\n    ask turtles with [ nwho = 8 ] [set xcor xcor - 1 wait .01 set heading heading * -1 wait .02]\n    ask turtles with [ nwho = 9 ] [set xcor xcor - 1 wait .01 set heading heading * -1 wait .02]]
NIL
1
T
OBSERVER
